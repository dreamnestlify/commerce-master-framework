...
### 26. ✅ 多语言支持 (英/德双语)
- Polylang 3.8.6 已安装配置: English (en_US, 默认) + Deutsch (de_DE)
- URL: /de/ 前缀隐藏默认语言, 14 个关键页面已翻译
- 语言切换器 EN | DE 已加入主导航菜单
- 德语语言包: WordPress core + WooCommerce (de_DE)
...
- [x] 库存管理 (31 商品, 15-80件)
- [x] Polylang 英德双语 (EN/DE 切换器 + 14 页面翻译)
- [x] 页脚水平排版修复 (writing-mode 强制)
- [x] 页眉菜单重组 (Shop 下拉菜单)
